...
outputs:
  filtered_vcf:
    ...
    outputBinding:
      glob: |
        ${
          var fname = inputs.input_gvcf.nameroot.replace("g.vcf", inputs.SNP_list.nameroot + "vcf"));
          return fname
          }
